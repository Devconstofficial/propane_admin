...
class JobManagementScreen extends GetView<JobController> {
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              controller.selectedDateStatus.value.isNotEmpty ?
                                              controller.selectedDateStatus.value : "Date",
                                              style: AppStyles.workSansTextStyle()
                                                  .copyWith(
                                                  fontSize: 14.sp,
                                                  fontWeight: FontWeight.w600,
                                          ...
                                          PopupMenuButton<String>(
                                            ...
                                            icon: const Icon(
                                                ...
                                                size: 16),
                                            onSelected: (value) {
                                              controller.selectedDateStatus.value = value;
                                            },
                                          ...
                                          Padding(
                                            padding: EdgeInsets.only(left: 16.w),
                                            child: Text(
                                              controller.selectedBookingStatus.value.isNotEmpty ?
                                              controller.selectedBookingStatus.value : "Booking Status",
                                              style: AppStyles.workSansTextStyle()
                                                  .copyWith(
                                                  fontSize: 14.sp,
                                                  fontWeight: FontWeight.w600,
                                          ...
                                          PopupMenuButton<String>(
                                            ...
                                            itemBuilder: (BuildContext context) => [
                                              PopupMenuItem(
                                                value: 'Pickup',
                                                child: Text('Pickup',style: AppStyles.interTextStyle()
                                                    .copyWith(
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.w400),),
                                              ),
                                              PopupMenuItem(
                                                value: 'Arrived At gaz station',
                                                child: Text('Arrived At gaz station',style: AppStyles.interTextStyle()
                                                    .copyWith(
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.w400),),
                                              ),
                                              PopupMenuItem(
                                                value: 'Depart from gaz station',
                                                child: Text('Depart from gaz station',style: AppStyles.interTextStyle()
                                                    .copyWith(
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.w400),),
                                              ),
                                              PopupMenuItem(
                                                value: 'Delivered',
                                                child: Text('Delivered',style: AppStyles.interTextStyle()
                                                    .copyWith(
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.w400),),
                                              ),
                                              PopupMenuItem(
                                                value: 'Cancelled',
                                                child: Text('Cancelled',style: AppStyles.interTextStyle()
                                                    .copyWith(
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.w400),),
                                              ),
                                          ...
                                          controller.selectedDateStatus.value.isNotEmpty ||
                                              controller.selectedLocation.value.isNotEmpty || controller.selectedBookingStatus.value.isNotEmpty ?
                                          Row(
                                            children: [
                                              Container(
                                                width: 1,
                                              ...
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  onTap: (){
                                                    controller.selectedDateStatus.value = '';
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: DataTable(
                                          ...
                                          rows: controller.currentJobPage
  ...
  DataRow _buildDataRow(String id, String name, String status,
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          Get.toNamed(kJobDetailScreenRoute);
